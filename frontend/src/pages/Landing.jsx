...
export default function Landing() {
  ...
  const features = [
    { icon: School,      title: 'Branded School Page',   desc: 'Every school gets a public page at Exclusive Grades.com/schoolname with logo, colors, and contact info.' },
  ...
  const steps = [
    { icon: School,     title: 'Register Your School',    desc: 'Sign up and instantly get your branded URL at Exclusive Grades.com/yourschool. No technical setup needed.' },
  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: 'Remove Exclusive Grades branding', included: false },
      ]
    },
    {
      ...
      features: [
        ...
        { text: 'Remove Exclusive Grades branding', included: true },
  ...
  const testimonials = [
    { quote: 'Exclusive Grades transformed how we handle results. Parents no longer queue at the school gate — they check results from their phones.', name: 'Adaeze Okonkwo', role: 'Principal, Sunrise Academy, Lagos', initials: 'AO' },
    ...
    <div className={`${styles.page} landing-page`}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p>Exclusive Grades gives every school a branded page, secure PIN-based result access, AI lesson notes, and ID card generation — all in one platform.</p>
      ...
      <section className={styles.howItWorks} id="how-it-works">
        <div className={styles.sectionHead}>
          ...
          <p className={styles.sectionSub}>From registration to your first result check — Exclusive Grades makes it effortless for any school.</p>
        </div>
      ...
      <section className={styles.features} id="features">
        <div className={styles.sectionHead}>
          ...
          <p className={styles.sectionSub}>From the school admin to the parent checking results on a phone — Exclusive Grades covers every touchpoint.</p>
        </div>
      ...
      <section className={styles.testimonials} id="testimonials">
        <div className={styles.sectionHead}>
          ...
          <p className={styles.sectionSub}>Real feedback from schools already using Exclusive Grades across Nigeria.</p>
        </div>
      ...
      <section className={styles.cta}>
        ...
        <p>Join hundreds of schools already using Exclusive Grades. Start free — no credit card required.</p>
