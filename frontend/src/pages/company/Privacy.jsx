...
const sections = [
  ...
  { title: '2. How We Use Your Information', body: 'We use collected information to operate the ExclusiveGrade platform, process PIN purchases and wallet transactions, send account confirmation and notification emails, and provide school administrators with analytics on PIN usage and result access.' },
  ...
  { title: '4. Student Data', body: 'Student data is owned by the school that uploaded it. ExclusiveGrade acts as a data processor on behalf of the school. When a result is accessed via PIN, only the student\'s name, class, term, and result scores are displayed — no other personal data is exposed.' },
  ...
  { title: '7. Your Rights', body: 'You have the right to access, correct, or delete your personal data. School administrators can manage student records directly from their dashboard. For account-level data requests, contact us at privacy@ExclusiveGrade.com.' },
    ...
    <div>
      ...
      <div className={styles.page}>
        <div className={styles.hero}>
          ...
          <p>Last updated: January 2025. This policy explains how ExclusiveGrade collects, uses, and protects your information.</p>
        </div>
